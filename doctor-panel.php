...
<html lang="en">
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, steelblue, darkblue);
}
              ...
              <div class="row">
               ...
               <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    ...
                    <span> <i class="fa fa-list" style="font-size: 43px" aria-hidden="true"></i></span>
                ...
                <div class="col-sm-4" style="left: 15%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                    <span><i class="fa fa-heartbeat" style="font-size: 43px" aria-hidden="true"></i></span>
