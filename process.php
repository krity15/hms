...
if(!empty($_POST['stripeToken'])){
    ...
    $stripe = array(
      "secret_key"      => "sk_test_51LRFjwKgp5HsEMHSTJaWn3pbv65olZzmu8ciuasMfFfmFRoZ835jQhuaEWN00Az9IXMYXGGB0mHUNIVgisKJ4gOa00A4N07LI5",
      "publishable_key" => "pk_test_51LRFjwKgp5HsEMHS6b8XXUUE4L4l5TWvbiyZhPHPDBftwYA8DZ4ZC4aRep8WyQ1aclD1ihq7BSUeK3gP6zLl6MuA00yAVJMXIN"
    );    
    ...
    if($paymenyResponse['amount_refunded'] == 0 && empty($paymenyResponse['failure_code']) && $paymenyResponse['paid'] == 1 && $paymenyResponse['captured'] == 1){
       ...
       if($lastInsertId && $paymentStatus == 'succeeded'){
            $paymentMessage = "The payment was successful. ID: {$orderNumber}";
       } else{
