...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(right, turquoise, #ecf6f9); background-size: cover;">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="services.html" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>ABOUT</h6></a>
          </li>
    ...
    animation: mover 1s infinite alternate;">
      ...
      <div style="color: white;">
         ...
         <div class="col-md-4" style="margin-top: 5%;right: 24%">
