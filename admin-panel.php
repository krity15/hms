    ...
    if((date("Y-m-d",$appdate1)==$cur_date and date("H:i:s",$apptime1)>$cur_time) or date("Y-m-d",$appdate1)>$cur_date) {
      $check_query = mysqli_query($con,"select apptime from appointmenttb where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
        ...
        if(mysqli_num_rows($check_query)==0){
          $query=mysqli_query($con,"insert into appointmenttb(pid,fname,lname,email,contact,doctor,docFees,appdate,apptime,userStatus,doctorStatus) values($pid,'$fname','$lname','$email','$contact','$doctor','$docFees','$appdate','$apptime','1','1')");
...
if(isset($_GET["generate_rep"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Patient Report </h2></br>
    
  ';
 
  $content .= generate_rep();
  $obj_pdf -> writeHTML($content);
  ob_end_clean();
  $obj_pdf -> Output("rep.pdf",'I');
...
<html lang="en">
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, steelblue, #ecf6f9);
}
               ...
               <div class="col-sm-4" style="left: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      <span><i class="fa fa-plus-square" style="font-size: 45px" aria-hidden="true"></i></span>
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                    <span ><i class="fa fa-stethoscope" style="font-size: 45px" aria-hidden="true"></i></span>
                ...
                <div class="col-sm-4" style="left: 20%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span> <i class="fa fa-heartbeat" style="font-size: 45px" aria-hidden="true"></i></span>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                              ...
                              <input type = "submit" onclick="alert('Generating Report');" name ="generate_rep" class = "btn btn-success" value="Report"/>
                              </a>
                              </td>
                              </form>
                              <td>
                              ...
                              <input type="submit"  onclick="" class = "btn btn-success" value="Pay"/>
                               </form>
                              </td>
                      </tr>
                    <?php }
