              ...
              <div class="row">
               <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    ...
                    <span><i class="fa fa-user-md" style="font-size: 43px" aria-hidden="true"></i></span>
                ...
                <div class="col-sm-4" style="left: -3%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                    <span><i class="fa fa-user" style="font-size: 43px" aria-hidden="true"></i></span>
                ...
                <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                    <span> <i class="fa fa-file" style="font-size: 43px" aria-hidden="true"></i></span>
                ...
                <div class="col-sm-4" style="left: 18%;margin-top: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                    <span> <i class="fa fa-user-plus" style="font-size: 45px" aria-hidden="true"></i></span>
    ...
    <div class="row">
            ...
            <div class="col-md-8">
             <select name="special" class="form-control" id="special" required="required">
                ...
                <option value="General Physician" name="spec">General Physician</option>
