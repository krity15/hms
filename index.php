...
function checklen()
{
    ...
    if(pass1.value.length == " "){  
        alert("Password field empty. Try again!");  
        return false;  
  }   
...
<body style="background: -webkit-linear-gradient(right, darkblue, skyblue); background-size: cover;">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="#" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>ABOUT</h6></a>
          </li>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 30px;">
